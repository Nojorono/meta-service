...
export class MtlTrxListsMicroserviceController {
  ...
  @ApiResponse({ status: 200, description: 'Material transaction lists retrieved successfully', type: [MtlTrxListsDto] })
  @ApiQuery({ name: 'page', required: false, type: Number, description: 'Page number' })
  @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Items per page' })
  @ApiQuery({ name: 'TRANSACTION_ID', required: false, type: Number, description: 'Transaction ID' })
  @ApiQuery({ name: 'ORGANIZATION_ID', required: false, type: Number, description: 'Organization ID' })
  @ApiQuery({ name: 'ORGANIZATION_CODE', required: false, type: String, description: 'Organization code' })
  @ApiQuery({ name: 'INVENTORY_ITEM_ID', required: false, type: Number, description: 'Inventory item ID' })
  @ApiQuery({ name: 'ITEM_CODE', required: false, type: String, description: 'Item code' })
  ...
  @ApiQuery({ name: 'SUBINVENTORY_CODE', required: false, type: String, description: 'Subinventory code' })
  ...
  @ApiResponse({ status: 200, description: 'Material transaction list retrieved successfully', type: MtlTrxListsDto })
  @ApiResponse({ status: 404, description: 'Material transaction list not found' })
