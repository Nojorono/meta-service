...
export class FpprSalesTypesDto {
  @ApiProperty({ description: 'Lookup type', example: 'FPPR_SALES_TYPE' })
  @IsOptional()
  @IsString()
  LOOKUP_TYPE?: string;

  @ApiProperty({ description: 'Lookup code', example: 'RETAIL' })
  @IsOptional()
  @IsString()
  LOOKUP_CODE?: string;

  @ApiProperty({ description: 'Meaning', example: 'Retail' })
  @IsOptional()
  @IsString()
  MEANING?: string;

  @ApiProperty({ description: 'Description', example: 'Retail sales type' })
  @IsOptional()
  @IsString()
  DESCRIPTION?: string;
