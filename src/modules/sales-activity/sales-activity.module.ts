...
import { SalesActivityMicroserviceController } from './controllers/sales-activity.microservice.controller';
import { SalesActivityService } from './services/sales-activity.service';

@Module({
  imports: [CommonModule],
  controllers: [SalesActivityController, SalesActivityMicroserviceController],
