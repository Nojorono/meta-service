...
export class ItemListMicroserviceController {
  ...
  @MessagePattern('item-list.findByInventoryItemIdAndOrgCode')
  async findByInventoryItemIdAndOrgCode(
    @Payload() dto: MetaItemListDtoByInventoryItemId,
  ) {
    console.log('dto', dto);
    return this.itemListService.getItemListByInventoryItemIdAndOrgCode(dto);
  }
