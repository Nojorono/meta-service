...
export class PositionController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a list of all positions from XTD_HR_POSITIONS_V view',
  })
  @ApiQuery({
    name: 'positionCode',
    required: false,
  ...
  async findAllPositions(
    @Query() queryDto: PositionQueryDto,
  ): Promise<PositionDto[]> {
    try {
  ...
  @ApiOperation({
    ...
    description:
      'Get the total count of positions matching the filter criteria',
  })
  @ApiQuery({
    name: 'positionCode',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all positions for a specific organization from XTD_HR_POSITIONS_V view',
  })
  @ApiParam({
    name: 'orgId',
  ...
  async findPositionsByOrganizationId(
    ...
    try {
      ...
      this.logger.error(
        `Error fetching positions by organization ID ${orgId}:`,
        error,
      );
      throw new HttpException(
        'Failed to fetch positions',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific position by its code from XTD_HR_POSITIONS_V view',
  })
  @ApiParam({
    name: 'code',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific position by its ID from XTD_HR_POSITIONS_V view',
  })
  @ApiParam({
    name: 'id',
